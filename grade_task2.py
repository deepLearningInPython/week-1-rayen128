...
def test_relu_default_cutoff():
    ...
    np.testing.assert_array_equal(
        ReLu(array.copy()), expected_output, "Failed on default cutoff")
...
def test_relu_custom_cutoff():
    ...
    np.testing.assert_array_equal(
        ReLu(array.copy(), 2), expected_output, "Failed on custom cutoff")
...
def test_relu_empty_array():
    ...
    np.testing.assert_array_equal(
        ReLu(array.copy()), expected_output, "Failed on empty array")
